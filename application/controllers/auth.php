...
class Auth extends Controller {
	...
	function index()
	{
		...
		//The codes below will be executed if the user is login as an admin.
	...
	function create_user()
	{
		...
		$this->form_validation->set_rules('email', 'Email Address', 'required|valid_email');
		$this->form_validation->set_rules('phone1', 'First Part of Phone', 'required|xss_clean|min_length[2]|max_length[3]');
		$this->form_validation->set_rules('phone2', 'Second Part of Phone', 'required|xss_clean|min_length[4]|max_length[4]');
	...
	function edit_profile()
	{
		...
		$this->data['id'] = array('name' => 'id',
		    ...
		    $userid = $this->session->userdata('id');
		$this->load->view('auth/edit_profile', $this->data);
